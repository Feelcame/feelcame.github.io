---
title: Упаковать программу в инсталлятор
...
- Просто zip-архив - большинство portrable програм так и распространяются
- Nullsoft Install System - классика
- Inno Setup. Норм
- [VMware InstallBuilder](https://installbuilder.com/download-step-2). Топчик, но платный
- В винде можно генерировать MSI, это тоже что-то типа инсталлятора. Юзают сисадмины
