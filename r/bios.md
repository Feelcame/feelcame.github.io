---
title: Настройка, патчинг, прошивка биоса
...
## Программатор
Иногда прошивка просто портится в чипе памяти и нужно просто прошить оригинальный дамп. Тогда в дело вступает программатор
- программатор CH341
- Програма для прошивки AsProgrammer
- иногда нужно модифицировать биос UEFI Tools