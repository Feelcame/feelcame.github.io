...
## Лампа
{: #lampa }
**Lampa** - программа для просмотра фильмов на телевизоре. Удобное управление пультом. Данные о фильмах берет из каталога [cub.watch](http://cub.watch), TMDB или filmix. Лампа - это каркас, в ней есть только информация про фильмы. С помощью плагинов можно добавить онлайн-просмотр, торренты, ТВ и т.д. 

Скачать можно на официальном сайте: <http://cub.watch/download/#install>

Как установить:
- На андроид-приставках или телефоне ставится как обычный APK-файл
...
- Остальные варианты смотрите по ссылке для скачивания выше
...
Просмотр онлайн-телевидения лампе. Требуется добавить свой плейлист на сайте [cub.watch](http://cub.watch)<br>
<details markdown="1">
