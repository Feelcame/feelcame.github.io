...
Компания Shopify создала систему гибкого скриптования шаблонов для своего сервиса интернет-магазинов shopify.com. Это напоминает мне о шаблонах TPL в OpenCart 3, которая написана на языке PHP. Там тоже используются похожие вставки типа ```\{{ code \}}```
...
### Переменные  
Задается несколькими путями. Основной - задать в заголовке:
``` title: test ```
...
Они все опубликованы, но ссылку не дам. Там есть интересные переменные. 
Вот например [site.github.repository_url]({{ site.github.repository_url }})  

[Боьше информации на официальном сайте](https://jekyllrb.com/docs/liquid/)
