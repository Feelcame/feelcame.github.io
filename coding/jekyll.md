...
то это нужно сделать в блоке raw:  
```
...
![image](https://user-images.githubusercontent.com/17731587/140235992-f18ff464-56b6-4077-b581-2a3daf003878.png)
...
**Еще вариант использовать HTML**. Тогда текст не будет отображаться браузером, но сохранится в исходниках страницы.
