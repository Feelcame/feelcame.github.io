...
upd. Припекло. Дописываю. Но все равно это только черновик
...
Библиотеки в формате IntLib нужно подключить через меню биюлиотек. Библиотеки в формате PcbLib и RomaLib нужно включить в спостав проекта печатной платы
* Для альтиума подходят [**универсальные библиотеки**](https://linker.pp.ua/hardware/PCB.html#библиотеки-компонентов)
<https://linker.pp.ua/hardware/PCB.html#библиотеки-компонентов>
* В самой программе есть встроенный поиск компонентов. Сам не пользовался, только знаяю что он есть
