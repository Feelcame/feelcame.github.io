...
### **Твики реестра**
Настройки винды хранятся в реестре. Туда и будем вносить изменения, автоматически. Это чисто для ускорения настройки, можешь заморочиться и настроить все вручную.  

Как пользоваться? В текстовый файл с расширением .reg копируешь текст ```Windows Registry Editor Version 5.00``` + пустая строка + сам твик.  
Из представленных здесь твиков можно собрать свой мегапак. Сохраняешь, запускаешь, радуешься!  
Или можешь скачать мой вариант, собранный из всех представленных ниже твиков: [ссылка](#).
